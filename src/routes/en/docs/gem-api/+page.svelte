...
<div class="alert alert-primary" role="alert">
	The API utilizes GEM models from the Canadian Meteorological Center, optimized for North America.
	However, updates every 6 hours may not reflect the latest weather developments. For accurate
...
<div class="col-12 py-5">
	...
	<p>
		This API uses <a
			href="https://en.wikipedia.org/wiki/Global_Environmental_Multiscale_Model"
			target="_new">Global Environmental Multiscale Model (GEM)</a
		> from the Canadian weather service. Global and regional weather models are combined into a seamless
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tbody>
				<tr>
					<th scope="row"
						><a href="https://weather.gc.ca/grib/grib2_glb_25km_e.html" target="_blank"
							>GEM Global</a
						></th
					>
					<td>Global</td>
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tbody>
				<tr>
					<th scope="row"
						>temperature_2m<br />temperature_40m<br />temperature_80m<br />temperature_120m</th
					>
					<td>Instant</td>
					<td>°C (°F)</td>
					<td
						>Air temperature at 2, 40, 80 or 120 meters above ground. 2 m is the standard level.</td
					>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>%</td>
					<td
						>Low level clouds and fog up to 3 km altitude. Note: Low, medium and high clouds are
						calculated from pressure level data. Totcal cloud cover might differ.</td
					>
				</tr>
				<tr>
				...
				<tr>
					...
					<td
						>Wind speed at 10, 40, 80 or 120 meters above ground. Wind speed on 10 meters is the
						standard level.
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>W/m²</td>
					<td
						>Diffuse solar radiation as average of the preceding hour. GEM does not offers diffuse
				...
				<tr>
					<th scope="row">soil_temperature_0_to_10cm</th>
					<td>Instant</td>
					<td>°C (°F)</td>
					<td>Average temperature in the soil at 0-10 cm depts.</td>
				</tr>
				<tr>
					<th scope="row">soil_moisture_0_to_10cm</th>
					<td>Instant</td>
					<td>m³/m³</td>
					<td>Average soil water content as volumetric mixing ratio at 0-10 cm depth.</td>
				</tr>
			</tbody>
		</table>
	</div>
	...
	<p>
		GEM includes a 1050 hPa level, which technically is to a level below ground. Please note, that
		this is not the soil temperature! If geopotential height is below ground, data should not be
		used.
	</p>
			...
			<tbody>
				...
				<tr>
					...
					<td
						...
						cover directly. It is approximated based on relative humidity using <a
